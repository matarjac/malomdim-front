            ...
            {props.isShown &&
                <ModalOverLay onClick={handleClose}>
                    <ModalBoxContent width={40} height={35} onClick={(e) => e.stopPropagation()}>
                        ...
                        <StyledInput type={'email'} placeholder={'Topic title'} onChange={(e) => inputTextChanged(e)} />
                        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '10px' }}>
                            <StyledDurationButtons onClick={increaseDay}><GeneralSpan fontSize={18} fontWeight={600}>+</GeneralSpan></StyledDurationButtons>
                            <GeneralSpan fontSize={30} fontWeight={600} style={{ width: '' }}>{durationCount} Days</GeneralSpan>
                            <StyledDurationButtons onClick={decreaseDay}><GeneralSpan fontSize={18} fontWeight={600}>-</GeneralSpan></StyledDurationButtons>
                        </div>
                        <StyledAddButton onClick={() => { handleAddTopic({ title: newTopicTitle, duration: durationCount }) }}>Add Topic</StyledAddButton>
                    </ModalBoxContent>
                </ModalOverLay>
            }
        </>
